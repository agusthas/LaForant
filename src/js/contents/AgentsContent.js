const AgentsContent = [
  {
    id: 0,
    name: 'VIPER',
    icon: '/assets/images/viper/viper-icon.png',
  ...
  },
  {
    ...
    icon: '/assets/images/sage/sage-icon.png',
  ...
  },
  {
    ...
    icon: '/assets/images/skye/skye-icon.png',
  ...
  },
  {
    ...
    icon: '/assets/images/astra/astra-icon.png',
  ...
  },
  {
    ...
    icon: '/assets/images/reyna/reyna-icon.png',
  ...
  },
  {
    ...
    icon: '/assets/images/killjoy/killjoy-icon.png',
  ...
  },
  {
    ...
    icon: '/assets/images/raze/raze-icon.png',
